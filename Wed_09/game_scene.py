...
class GameScene(Scene):
    ...
    def update(self):
        ...
        # every update check if an alien should be created
        ...
        # check if a missile is off screen
        ...
        # check if a alien is off screen
        ...
        # check if missile has touched alien
        if len(self.aliens) > 0 and len(self.missiles):
            for alien in self.aliens:
                for missile in self.missiles:
